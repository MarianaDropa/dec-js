...
// - створити функцію яка створює параграф з текстом. Текст задати через аргумент площа квадрата
 function p(a,b){
     let result = a * b;
     return result;
 }
 let resulFinish = p(25,25);
 document.write(`<p> Площа квадрата рівна: ${resulFinish} mm</p>`)
...
//     Кількість li визначається другим аргументом, який є числовим (тут використовувати цикл)
 ...
 f4('хочу на сейшели',4);


// - створити функцію яка приймає масив примітивних елементів (числа,стрінги,булеві), та будує для них список

 let primitiveMass = [15, false, 'YO', 3.14, true, 94];
 function list (){
     document.write(`<div>`)
...
// 'Для кожного об'єкту окремий блок.
 ...
 let massObject = [
     {name:'oak', id:1, age:15},
     {name:'ash', id:2, age:23},
     {name:'beech', id:3, age:32},
     {name:'pine', id:4, age:37}
 ]
